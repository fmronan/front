...
namespace Viteloge\InseeBundle\Entity {
     ...
     * @ORM\Entity(repositoryClass="Viteloge\InseeBundle\Repository\InseeStateRepository")
     */
    class InseeState extends InseeEntity {
        ...
        /**
         * @ORM\OneToMany(targetEntity="Viteloge\InseeBundle\Entity\InseeDepartment", mappedBy="inseeState")
         */
         ...
         * @return InseeState
         */
        public function addInseeDepartment(\Viteloge\InseeBundle\Entity\InseeDepartment $inseeDepartment) {
         ...
         * @param \Viteloge\InseeBundle\Entity\InseeDepartment $inseeDepartment
         */
        public function removeInseeDepartment(\Viteloge\InseeBundle\Entity\InseeDepartment $inseeDepartment) {
