...
namespace Viteloge\InseeBundle\Entity {
     ...
     * @ORM\Entity(repositoryClass="Viteloge\InseeBundle\Repository\InseeDepartmentRepository")
     */
    class InseeDepartment extends InseeEntity {
         ...
         *
         * @ORM\ManyToOne(targetEntity="Viteloge\InseeBundle\Entity\InseeState", inversedBy="inseeDepartments")
         * @ORM\JoinColumns({
        ...
        /**
         * @ORM\OneToMany(targetEntity="Viteloge\InseeBundle\Entity\InseeCity", mappedBy="inseeDepartment")
         */
         ...
         * Set inseeCapital
         *
         * @param \Viteloge\InseeBundle\Entity\InseeCity $inseeCapital
         * @return InseeDepartement
         */
        public function setInseeCapital(\Viteloge\InseeBundle\Entity\InseeCity $inseeCapital = null) {
         ...
         * Add inseeDepartment
         *
         * @param \Viteloge\InseeBundle\Entity\InseeDepartment $inseeCity
         * @return InseeDepartment
         */
        public function addInseeCity(\Viteloge\InseeBundle\Entity\InseeCity $inseeCity) {
         ...
         */
        public function removeInseeCity(\Viteloge\InseeBundle\Entity\InseeCity $inseeCity) {
